...
const SectionHeader = () => {  return (
    <div className="grid grid-cols-1 gap-2 md:gap-8 min-[1000px]:flex min-[1000px]:flex-row min-[1000px]:items-center min-[1000px]:gap-12 xl:gap-20">
      ...
      <div className="shrink-0">
        <p className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-semibold leading-tight tracking-tight text-gray-900 mb-2 sm:mb-2 md:mb-0 xl:mb-0">
          Latest From
        </p>

        <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:gap-4 -mt-2">
          <p className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-normal leading-tight tracking-tighter text-gray-900">
            The Ground
          </p>

          {/* Striped gradient bar */}
          <div className="relative overflow-hidden shrink-0 w-[120px] sm:w-[110px] md:w-[140px] lg:w-50 xl:w-52 h-8 sm:h-9 md:h-11 lg:h-16 xl:h-15 m-1 xl:ml-3">
            <img
              src={FadedBar}
              alt=""
              aria-hidden="true"
